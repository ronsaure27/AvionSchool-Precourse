...
// workaround for the huge logo blocking the whole page
var logo = document.querySelector('img');
logo.style.height = "55.5px";
logo.style.width = "176.9px";
...
// code here
document.getElementById('createdBy').innerHTML += 'This app was created by: Zenith Manuel';
/*
...
function buildToDos(toDos) {
  // code here
  let arrTodos = toDos.map((item, index)=>{
    return buildToDo(item, index);
  });
  return arrTodos;
}
...
/*
  STEP 7: This function, 'addToDo' will add a new ToDo to the 'toDoItems' array.
          ...
          'toDoInput' is a text input element. All text input elements have a property called 'value', this value will be whatever is typed into
...
/*    1.) Research 'checkbox' input types. And apply that research to the buildToDo function:
        a.) Create a checkbox in the buildToDo function.
